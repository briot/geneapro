...
declare var app : angular.IModule;   // provided from javascript

module GP {

   export enum layoutScheme {EXPANDED = 0, COMPACT }
   export enum appearance {FLAT = 0, GRADIENT}
   export enum linkStyle {STRAIGHT = 0, ORTHOGONAL, CURVE}
