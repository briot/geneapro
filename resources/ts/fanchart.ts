...
import {app} from './app';
import {IPerson, IRectangle, IFanchartSettings, IGPRootScope,
   colorScheme} from './basetypes';
import {PedigreeService} from './pedigree.service';
import {GPd3Service, ANIMATION_DURATION} from './gpd3';
import {ContextMenu} from './contextmenu';
import {HALF_PI, TWO_PI, math} from './services';
...
const html = require('geneaprove/fanchart.html');
