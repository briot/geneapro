# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2017-03-27 13:40
from __future__ import unicode_literals

from django.db import migrations, models
import django.db.models.deletion
import django.utils.timezone
import geneaprove.models.base
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text=b'True if this is an administrative task (see matching table), or False if this is a search to perform')),
                ('status', models.TextField(help_text=b'Could be either completed, on hold,...', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rationale', models.TextField(help_text=b'Explains why the assertion (deduction, comments,...)', null=True)),
                ('disproved', models.BooleanField(default=False)),
                ('last_change', models.DateTimeField(default=django.utils.timezone.now, help_text=b'When was the assertion last modified')),
            ],
            options={
                'db_table': 'assertion',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(help_text=b'Name of the characteristic. This could be guessed from its parts only if there is one of the latter, so we store it here')),
                ('date_sort', models.DateTimeField(null=True)),
                ('date', geneaprove.models.base.PartialDateField(base_date_field=b'date_sort', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gedcom', models.CharField(blank=True, help_text=b'Name in Gedcom files', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('schema_version', models.IntegerField(default=1, editable=False, help_text=b'Version number of this database. Used to detect what updates need to be performed')),
            ],
            options={
                'db_table': 'config',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('date_sort', models.DateTimeField(null=True)),
                ('date', geneaprove.models.base.PartialDateField(base_date_field=b'date_sort', help_text=b'The date of the event, as found in the original source. This date is internally parsed into date_sort which is used for sorting purposes', null=True)),
            ],
            options={
                'db_table': 'event',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(blank=True, help_text=b'The event type for which the role is defined. If unset, this applies to all events', null=True, on_delete=django.db.models.deletion.CASCADE, to='geneaprove.Event_Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_sort', models.DateTimeField(null=True)),
                ('date', geneaprove.models.base.PartialDateField(base_date_field=b'date_sort', null=True)),
                ('criteria', models.TextField(help_text=b'The criteria for admission in a group. For instance, one group might be all neighbors listed in a particular document, and another group might be a similar group listed in another document, or same document at a different time', null=True)),
            ],
            options={
                'db_table': 'group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_sort', models.DateTimeField(null=True)),
                ('date', geneaprove.models.base.PartialDateField(base_date_field=b'date_sort', null=True)),
                ('name', models.CharField(help_text=b'Short description of the place', max_length=100)),
                ('parent_place', models.ForeignKey(help_text=b'The parent place, that contains this one', null=True, on_delete=django.db.models.deletion.CASCADE, to='geneaprove.Place')),
            ],
            options={
                'ordering': ('date_sort',),
                'db_table': 'place',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('sequence_number', models.PositiveSmallIntegerField(default=1, verbose_name=b'Sequence number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField(null=True)),
                ('client_data', models.TextField(help_text=b'The client for which the project is undertaken. In general this will be the researched himself', null=True)),
            ],
            options={
                'db_table': 'project',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('comment', models.TextField(help_text=b'Contact information for this researcher, like email or postal addresses,...', null=True)),
            ],
            options={
                'db_table': 'researcher',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.TextField(help_text=b'Role that the researcher plays for that project', null=True)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='geneaprove.Project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_date', geneaprove.models.base.PartialDateField(base_date_field=b'subject_date_sort', help_text=b'the date of the subject. Note that the dates might be different for the various levels of source (a range of dates for a book, and a specific date for an extract for instance). This field contains the date as found in the original document. subject_date_sort stores the actual computed from subject_date, for sorting purposes', null=True)),
                ('medium', models.TextField(help_text=b'The type of the source, used to construct the citation.\nThe value for this field is the key into the citations.py dictionary that\ndocuments the citation styles.', null=True)),
                ('title', models.TextField(default=b'Untitled', help_text=b'The (possibly computed) full citation for this source', null=True)),
                ('abbrev', models.TextField(default=b'Untitled', help_text=b'An (possibly computed) abbreviated citation', null=True)),
                ('biblio', models.TextField(default=b'Untitled', help_text=b'Full citation for a bibliography', null=True)),
                ('comments', models.TextField(null=True)),
                ('last_change', models.DateTimeField(default=django.utils.timezone.now)),
                ...
                ('jurisdiction_place', models.ForeignKey(help_text=b'Example: a record in North Carolina describes a person and their activities in Georgia. Georgia is the subject place, whereas NC is the jurisdiction place', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='jurisdiction_for', to='geneaprove.Place')),
                ('repositories', models.ManyToManyField(related_name='sources', through='geneaprove.Repository_Source', to='geneaprove.Repository')),
                ('researcher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='geneaprove.Researcher')),
                ('subject_place', models.ForeignKey(help_text=b'Where the event described in the source takes place', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sources', to='geneaprove.Place')),
            ],
            options={
                'db_table': 'source',
            },
        ...
        migrations.AddField(
            model_name='search',
            name='source',
            field=models.ForeignKey(help_text=b'The source in which the search was conducted. It could be null if this was a general search in a repository for instance', null=True, on_delete=django.db.models.deletion.CASCADE, to='geneaprove.Source'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='assertion',
            name='source',
            field=models.ForeignKey(help_text=b'An assertion comes from no more than one source. It can also come from one or more other assertions through the assertion_assertion table, in which case source_id is null', null=True, on_delete=django.db.models.deletion.CASCADE, to='geneaprove.Source'),
        ),
        migrations.AddField(
            model_name='assertion',
            name='surety',
