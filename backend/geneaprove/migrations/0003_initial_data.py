...
def forward(apps, schema_editor):
    ...
    CPT.objects.using(db_alias).bulk_create([
        ...
        CPT(gedcom="AGE",       is_name_part=False,  name="age"),
        ...
        CPT(gedcom="PROP",      is_name_part=False,
        ...
        CPT(gedcom="DSCR",      is_name_part=False,
            name="physical description"),
        CPT(gedcom="RELI",      is_name_part=False,  name="religion"),
        CPT(gedcom="IDNO",      is_name_part=False,
            name="national identification number"),
        CPT(gedcom="NATI",      is_name_part=False,
            name="national or tribe origin"),
        CPT(gedcom="RFN",       is_name_part=False,  name="record file number"),
        CPT(gedcom="AFN",       is_name_part=False,
