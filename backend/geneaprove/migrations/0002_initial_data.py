...
def forward(apps, schema_editor):
    ...
    CPT.objects.using(db_alias).bulk_create([
        ...
        CPT(gedcom="",          is_name_part=False,  name="number of marriages"),
        ...
        CPT(gedcom="",          is_name_part=False,  name="social security number"),
        CPT(gedcom="",          is_name_part=False,  name="telephone"),
        CPT(gedcom="",          is_name_part=False,  name="title"),
